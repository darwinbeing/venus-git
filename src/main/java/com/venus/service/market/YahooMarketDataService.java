...
public class YahooMarketDataService {
    ...
    public List<HistoricalData> getMarketData(StockIndex index,TimePeriod period, int historyDays ){
        return getMarketData(index.getCode(MarketDataProvider.YAHOO), period, historyDays);
    }
